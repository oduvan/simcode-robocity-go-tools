...
// module github.com/oduvan/simcode-go that the user's unchanged main.go
// compiles against via a temporary go.work.
package robocitytools

import "embed"

// ClientFiles is the embedded source of ./localclient (the simcode package + its engine
// subpackage). robocity-sim writes it to a temp dir, rewrites the import path
// prefix to github.com/oduvan/simcode-go, and adds a generated go.mod.
//
//go:embed all:localclient
